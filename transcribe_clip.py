...
- WHISPER_MODEL env: tiny, base, small, medium, large-v2, large-v3 (default: large-v2). Larger = better quality, slower.
"""
import json
import os
import re
...
def main () -> int:
	...
	model_name = os.environ.get('WHISPER_MODEL', 'large-v2').strip() or 'large-v2'
	if VERBOSE:
